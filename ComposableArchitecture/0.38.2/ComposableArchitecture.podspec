...
Pod::Spec.new do |spec|
  ...
  spec.dependency "CombineSchedulers", ">= 0.6.0", "<1.0.0"
  spec.dependency "CasePaths", ">= 0.8.0", "<1.0.0"
  spec.dependency "CustomDump", ">= 0.3.0", "<1.0.0"
  spec.dependency "IdentifiedCollections", ">= 0.3.2", "<1.0.0"
